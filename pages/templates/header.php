...
<header>
	<nav id="top_navbar" class="header_top navbar navbar-static-top">
		...
		<ul class="items-list">
			<li class="one-item <?php if ($page == 'price') echo 'active' ?>" id="price">
				<a href="<?php echo MAIN_URL ?>/price/chenhlech">Giá Chênh Lệch</a>
			</li>
			<li class="one-item <?php if ($page == 'exchange') echo 'active' ?>" id="exchange">
				<a href="<?php echo MAIN_URL ?>/exchange">Giao Dịch</a>
			</li>
...
<div id="main-content" class="page-<?php echo $page ?>">
	<menu class="menu-left col-lg-3">
		<?php if ($page == 'user') include 'menu/user.php';
