...
var API_URL = 'http://45.119.82.176:8000';
...
function logout (autoLoggedOut = false) {
	...
	$('[href*="/logout"]').click(function () {
        //popup('<div class="popup-section section-light">Đang đăng xuất khỏi tài khoản </b>...</div>');
		mtip('', 'info', '', 'Đang đăng xuất khỏi tài khoản </b>...')
        logout();
        setTimeout(function () {
            remove_popup();
        }, 1000);
